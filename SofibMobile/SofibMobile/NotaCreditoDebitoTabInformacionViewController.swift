...
class NotaCreditoDebitoTabInformacionViewController: UIViewController {
        ...
        if let solicitud = DetalleNotaCreditoDebitoViewController.jsonDetalleNotaCreditoDebito as? Dictionary<String, Any>{
           ...
           //  txtValorTotalPagar.text = FormatoDinero.formatearMoneda(texto:(solicitud["valorTotalPagar"] as? String ?? ""))
            ...
            txtNumeroNota.text = (solicitud["nroNota"] as? String ?? "")
             ...
             txtValorTotalNotaCredito.text = FormatoDinero.formatearMoneda(texto:(solicitud["valorTotalNotaCredito"] as? String ?? ""))
    ...
    */
    ...
    @IBAction func btnAjustes(_ sender: AnyObject) {
        AjustesViewController.viewBack = "notaNotaController"
