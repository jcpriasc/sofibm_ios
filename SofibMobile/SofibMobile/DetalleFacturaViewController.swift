...
class DetalleFacturaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblValorTotalFactura.text = NSLocalizedString("lbl_valor_total_factura", comment: "lbl_valor_total_factura")+": "+FormatoDinero.formatearMoneda(texto:FacturaViewController.facturaSeleccionada.valorTotalFactura)!
    ...
    func obtenerDetalle(){
        ...
        //let url = URL(string: "http://pruebas-sectorsalud.coomeva.com.co/saludmp-ws/jax-rs/saludmp-sofibmobile/factura/detalle/SAC/"+PropertiesProject.TOKEN+"/315")
    ...
    @IBAction func btnAjustes(_ sender: AnyObject) {
        AjustesViewController.viewBack = "detalleFactura"
